-- @description Item Mini Inspector
-- @version 1.0
-- @author MS_BANG
...
-- ImGui init
-- =====================
local ctx = reaper.ImGui_CreateContext('Item Mini Inspector')
...
local function loop()
  ...
  local visible, open = reaper.ImGui_Begin(ctx, 'Item Mini Inspector', true, win_flags)
