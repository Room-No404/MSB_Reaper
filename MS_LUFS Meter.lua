-- @description MS_LUFS_Analyzer
-- @author MS
-- @requires ReaImGui v0.9.0+
...
local ctx = reaper.ImGui_CreateContext('MS_LUFS_Analyzer')
...
local function loop()
    ...
    local vis, open = reaper.ImGui_Begin(ctx, 'MS_LUFS_Analyzer', true, reaper.ImGui_WindowFlags_NoScrollbar())
